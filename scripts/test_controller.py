...
class TestController(object):
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self._action_msg.ref_position.data[1] = p0
            self._action_msg.ref_velocity.data[1] = v0
            self._action_msg.ref_position.data[2] = p0
            self._action_msg.ref_velocity.data[2] = v0
